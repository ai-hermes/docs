...
- [4. Windows: Unable to check for updates](#4-windows-unable-to-check-for-updates)
...
In the meantime, to update to the latest version, please visit the [Download page](/en/download) to manually download and install the latest installer.
